...
run="$workspace/runs/QHIST-E0-v10-traj-$precision-r1"
log="$workspace/logs/trajectory-$precision.log"
exit_file="$workspace/logs/trajectory-$precision.exit"
...
precision-env/bin/python code/qhist_model_server_v10.py \
  --precision "$precision" \
...
toolsandbox-env/bin/python code/qhist_trajectory_batch_v10.py \
  --precision "$precision" \
  --assets runs/QHIST-E0-v10-assets-r8 \
  --rendered runs/QHIST-E0-v10-rendered-r8 \
...
precision-env/bin/python code/qhist_combine_trajectory_batch_v10.py \
  --precision "$precision" \
