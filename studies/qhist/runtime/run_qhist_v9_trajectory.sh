...
run="$workspace/runs/QHIST-E0-v9-traj-$precision-r1"
...
precision-env/bin/python code/qhist_model_server_v9.py \
  --precision "$precision" \
...
toolsandbox-env/bin/python code/qhist_trajectory_batch_v9.py \
  --precision "$precision" \
  --assets runs/QHIST-E0-v9-assets-r2 \
  --rendered runs/QHIST-E0-v9-rendered-r2 \
...
precision-env/bin/python code/qhist_combine_trajectory_batch_v9.py \
  --precision "$precision" \
