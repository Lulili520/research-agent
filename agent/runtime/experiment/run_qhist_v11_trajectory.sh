...
run="$workspace/runs/QHIST-E0-v11-traj-$precision-r1"
log="$workspace/logs/v11-trajectory-$precision.log"
exit_file="$workspace/logs/v11-trajectory-$precision.exit"
...
precision-env/bin/python code/qhist_model_server_v11.py \
  --precision "$precision" \
...
toolsandbox-env/bin/python code/qhist_trajectory_batch_v11.py \
  --precision "$precision" \
  --assets runs/QHIST-E0-v11-assets-r5 \
  --rendered runs/QHIST-E0-v11-rendered-r5 \
...
precision-env/bin/python code/qhist_combine_trajectory_batch_v11.py \
  --precision "$precision" \
