#!/usr/bin/env python3
"""独立重算 Q-HIST v13 E0 的 F/V/G/B/E/T、clean、复现与资源门。"""
...
def independently_build_schedule(
    ...
    for key in keys:
        ...
        random.Random(f"{seed}|{precision}|{key}|v13").shuffle(block)
...
def main() -> int:
    ...
    parser.add_argument("--run-prefix", default="QHIST-E0-v13-traj")
