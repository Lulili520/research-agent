...
run="$workspace/runs/QHIST-E0-v14-traj-$precision-r1"
log="$workspace/logs/v14-trajectory-$precision.log"
exit_file="$workspace/logs/v14-trajectory-$precision.exit"
...
precision-env/bin/python code/qhist_model_server_v14.py \
  --precision "$precision" \
...
toolsandbox-env/bin/python code/qhist_trajectory_batch_v14.py \
  --precision "$precision" \
...
precision-env/bin/python code/qhist_combine_trajectory_batch_v14.py \
  --precision "$precision" \
