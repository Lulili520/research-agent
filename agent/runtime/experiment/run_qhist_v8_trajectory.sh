...
workspace=/root/autodl-tmp/qhist-e0-v8
run="$workspace/runs/trajectories/$precision"
...
toolsandbox-env/bin/python code/qhist_trajectory_batch.py \
  --precision "$precision" \
  --assets assets/v8-r1 \
  --rendered rendered/v8-r1 \
...
precision-env/bin/python code/qhist_combine_trajectory_batch.py \
  --precision "$precision" \
