...
5. Extract narrow evidence statements with page, section, figure, or table locators. Keep source-reported results separate from author interpretation and agent inference.
